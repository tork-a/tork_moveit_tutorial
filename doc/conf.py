...
htmlhelp_basename = 'MoveitTutorialLdoc'

# -- Options for LaTeX output ---------------------------------------------

latex_elements = {
# The paper size ('letterpaper' or 'a4paper').
'papersize': 'a4paper,dvipdfmx',

# The font size ('10pt', '11pt' or '12pt').
#'pointsize': '10pt',

# Additional stuff for the LaTeX preamble.
  'preamble': '\setcounter{chapter}{0}\setcounter{tocdepth}{3}',
...
latex_documents = [
  (master_doc, 'tork_moveit_tutorial.tex', u'MoveIt Tutorial Documentation',
...
man_pages = [
    (master_doc, 'tork_moveit-tutorial', u'MoveIt Tutorial Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'moveit-tutorial_ja', u'MoveIt Tutorial Documentation',
   author, 'moveit-tutorial_ja', 'MoveIt Tutorial.',
   'Miscellaneous'),
]
